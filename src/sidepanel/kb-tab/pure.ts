...
export function renderFocusGapsHtml(gaps: iFocusGap[]): string {
  return `<details${gaps.length > 0 ? " open" : ""}>
    <summary class="cur-pointer" style="padding:var(--ds-space-4) var(--ds-space-6);font-size:var(--ds-text-md);font-weight:800;color:var(--ds-red-700);border-bottom:1px solid var(--ds-zinc-200);background:var(--ds-red-50)">Focus Gaps — ${gaps.length} elements</summary>
...
export function renderFocusIndicatorsHtml(indicators: iFocusIndicator[]): string {
  ...
  return `<details${failed.length > 0 ? " open" : ""}>
    <summary class="cur-pointer" style="padding:var(--ds-space-4) var(--ds-space-6);font-size:var(--ds-text-md);font-weight:800;color:var(--ds-amber-600);border-bottom:1px solid var(--ds-zinc-200);background:var(--ds-amber-50)">Focus Indicators — ${failed.length} missing</summary>
...
export function renderKeyboardTrapsHtml(traps: iKeyboardTrap[], tabOrderEmpty: boolean): string {
  return `<details${traps.length > 0 ? " open" : ""}>
    <summary class="cur-pointer" style="padding:var(--ds-space-4) var(--ds-space-6);font-size:var(--ds-text-md);font-weight:800;color:var(--ds-red-600);border-bottom:1px solid var(--ds-zinc-200);background:var(--ds-red-50)">Keyboard Traps — ${traps.length}</summary>
...
export function renderSkipLinksHtml(links: iSkipLink[], tabOrderEmpty: boolean): string {
  return `<details>
    <summary class="cur-pointer" style="padding:var(--ds-space-4) var(--ds-space-6);font-size:var(--ds-text-md);font-weight:800;color:var(--ds-sky-700);border-bottom:1px solid var(--ds-zinc-200);background:var(--ds-blue-50)">Skip Links — ${links.length}</summary>
