...
export function buildKbTabHtml(): string {
  ...
  return `
    <div class="fs-0" style="padding:8px 12px;border-bottom:1px solid var(--ds-zinc-200);display:flex;gap:8px;background:var(--ds-zinc-50)">
      <button id="kb-analyze" class="f-1 cur-pointer min-h-24" style="padding:8px;font-size:var(--ds-text-md);font-weight:800;color:var(--ds-amber-cta-fg);background:var(--ds-amber-500);border:none;border-radius:4px">Analyze</button>
      ${kbAnalyzed ? '<button id="kb-clear" class="cur-pointer min-h-24" style="padding:4px 10px;font-size:var(--ds-text-base);font-weight:700;color:var(--ds-red-600);border:1px solid var(--ds-red-200);border-radius:4px;background:none">Clear</button>' : ""}
    </div>
    ${!kbAnalyzed ? '<div class="f-1" style="padding:16px;text-align:center;font-size:var(--ds-text-md);color:var(--ds-zinc-500)">Click Analyze to scan keyboard navigation.</div>' : ""}
    ${kbAnalyzed ? `<div id="kb-scroll-container" class="f-1" style="overflow-y:auto;min-height:0">
      <details open>
        <summary class="cur-pointer" style="padding:8px 12px;font-size:var(--ds-text-md);font-weight:800;color:var(--ds-zinc-900);border-bottom:1px solid var(--ds-zinc-200);background:var(--ds-zinc-50);display:flex;align-items:center;gap:8px">
      ...
      <details${focusGaps.length > 0 ? " open" : ""}>
        <summary class="cur-pointer" style="padding:8px 12px;font-size:var(--ds-text-md);font-weight:800;color:var(--ds-red-700);border-bottom:1px solid var(--ds-zinc-200);background:var(--ds-red-50)">Focus Gaps — ${focusGaps.length} elements</summary>
      ...
      <details${failedIndicators.length > 0 ? " open" : ""}>
        <summary class="cur-pointer" style="padding:8px 12px;font-size:var(--ds-text-md);font-weight:800;color:var(--ds-amber-600);border-bottom:1px solid var(--ds-zinc-200);background:var(--ds-amber-50)">Focus Indicators — ${failedIndicators.length} missing</summary>
      ...
      <details${keyboardTraps.length > 0 ? " open" : ""}>
        <summary class="cur-pointer" style="padding:8px 12px;font-size:var(--ds-text-md);font-weight:800;color:var(--ds-red-600);border-bottom:1px solid var(--ds-zinc-200);background:var(--ds-red-50)">Keyboard Traps — ${keyboardTraps.length}</summary>
      ...
      <details>
        <summary class="cur-pointer" style="padding:8px 12px;font-size:var(--ds-text-md);font-weight:800;color:var(--ds-sky-700);border-bottom:1px solid var(--ds-zinc-200);background:var(--ds-blue-50)">Skip Links — ${skipLinks.length}</summary>
    ...
    <div class="fs-0" style="border-top:2px solid var(--ds-zinc-300);background:var(--ds-zinc-100)">
      <div role="group" aria-labelledby="kb-highlight-label" style="display:flex;align-items:center;gap:6px;padding:6px 12px">
        ...
        <label class="cur-pointer min-h-24" style="display:flex;align-items:center;gap:4px;font-size:var(--ds-text-base);font-weight:700;color:var(--ds-zinc-700);padding:4px 8px;border:1px solid var(--ds-zinc-300);border-radius:4px;background:#fff">
