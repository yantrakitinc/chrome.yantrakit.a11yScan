...
export function buildKbTabHtml(): string {
  ...
  return `
    <div class="fs-0" style="padding:var(--ds-space-4) var(--ds-space-6);border-bottom:1px solid var(--ds-zinc-200);display:flex;gap:var(--ds-space-4);background:var(--ds-zinc-50)">
      <button id="kb-analyze" class="f-1 cur-pointer min-h-24" style="padding:var(--ds-space-4);font-size:12px;font-weight:800;color:var(--ds-amber-cta-fg);background:var(--ds-amber-500);border:none;border-radius:var(--ds-radius-3)">Analyze</button>
      ${kbAnalyzed ? '<button id="kb-clear" class="cur-pointer min-h-24" style="padding:var(--ds-space-2) var(--ds-space-5);font-size:11px;font-weight:700;color:var(--ds-red-600);border:1px solid var(--ds-red-200);border-radius:var(--ds-radius-3);background:none">Clear</button>' : ""}
    </div>
    ${!kbAnalyzed ? '<div class="f-1" style="padding:var(--ds-space-8);text-align:center;font-size:12px;color:var(--ds-zinc-500)">Click Analyze to scan keyboard navigation.</div>' : ""}
    ${kbAnalyzed ? `<div id="kb-scroll-container" class="f-1" style="overflow-y:auto;min-height:0">
      <details open>
        <summary class="cur-pointer" style="padding:var(--ds-space-4) var(--ds-space-6);font-size:12px;font-weight:800;color:var(--ds-zinc-900);border-bottom:1px solid var(--ds-zinc-200);background:var(--ds-zinc-50);display:flex;align-items:center;gap:var(--ds-space-4)">
      ...
      <details${focusGaps.length > 0 ? " open" : ""}>
        <summary class="cur-pointer" style="padding:var(--ds-space-4) var(--ds-space-6);font-size:12px;font-weight:800;color:var(--ds-red-700);border-bottom:1px solid var(--ds-zinc-200);background:var(--ds-red-50)">Focus Gaps — ${focusGaps.length} elements</summary>
        <div style="padding:${focusGaps.length > 0 ? "12px" : "0"};display:flex;flex-direction:column;gap:6px">
          ${focusGaps.length === 0
            ...
            : focusGaps.map((g) => `
              <div class="kb-gap cur-pointer" role="button" tabindex="0" aria-label="Highlight focus gap: ${escHtml(g.selector)}" data-selector="${escHtml(g.selector)}" style="font-size:11px;padding:var(--ds-space-4);border:1px solid var(--ds-red-200);background:var(--ds-red-50);border-radius:var(--ds-radius-3)">
      ...
      <details${failedIndicators.length > 0 ? " open" : ""}>
        <summary class="cur-pointer" style="padding:var(--ds-space-4) var(--ds-space-6);font-size:12px;font-weight:800;color:var(--ds-amber-600);border-bottom:1px solid var(--ds-zinc-200);background:var(--ds-amber-50)">Focus Indicators — ${failedIndicators.length} missing</summary>
        <div style="padding:${failedIndicators.length > 0 ? "12px" : "0"};display:flex;flex-direction:column;gap:6px">
          ${focusIndicators.length === 0
            ...
            : failedIndicators.length === 0
              ? '<div style="padding:var(--ds-space-6);font-size:11px;color:var(--ds-green-700);text-align:center">All focusable elements have visible focus indicators.</div>'
              : failedIndicators.map((fi) => `
                <div class="kb-fi cur-pointer" role="button" tabindex="0" aria-label="Highlight missing focus indicator: ${escHtml(fi.selector)}" data-selector="${escHtml(fi.selector)}" style="font-size:11px;padding:var(--ds-space-4);border:1px solid var(--ds-amber-200);background:var(--ds-amber-50);border-radius:var(--ds-radius-3)">
      ...
      <details${keyboardTraps.length > 0 ? " open" : ""}>
        <summary class="cur-pointer" style="padding:var(--ds-space-4) var(--ds-space-6);font-size:12px;font-weight:800;color:var(--ds-red-600);border-bottom:1px solid var(--ds-zinc-200);background:var(--ds-red-50)">Keyboard Traps — ${keyboardTraps.length}</summary>
        <div style="padding:${keyboardTraps.length > 0 ? "12px" : "0"};display:flex;flex-direction:column;gap:6px">
          ${tabOrder.length === 0
            ...
            : keyboardTraps.length === 0
              ? '<div style="padding:var(--ds-space-6);font-size:11px;color:var(--ds-green-700);text-align:center">No keyboard traps detected.</div>'
              : keyboardTraps.map((t) => `
                <div class="kb-trap cur-pointer" role="button" tabindex="0" aria-label="Highlight keyboard trap: ${escHtml(t.selector)}" data-selector="${escHtml(t.selector)}" style="font-size:11px;padding:var(--ds-space-4);border:1px solid var(--ds-red-200);background:var(--ds-red-50);border-radius:var(--ds-radius-3)">
      ...
      <details>
        <summary class="cur-pointer" style="padding:var(--ds-space-4) var(--ds-space-6);font-size:12px;font-weight:800;color:var(--ds-sky-700);border-bottom:1px solid var(--ds-zinc-200);background:var(--ds-blue-50)">Skip Links — ${skipLinks.length}</summary>
        <div style="padding:${skipLinks.length > 0 ? "12px" : "0"};display:flex;flex-direction:column;gap:6px">
          ${tabOrder.length === 0
            ...
            : skipLinks.length === 0
              ? '<div style="padding:var(--ds-space-6);font-size:11px;color:var(--ds-amber-600);text-align:center">No skip links found. Consider adding a "Skip to main content" link.</div>'
              : skipLinks.map((sl) => `
                <div style="font-size:11px;padding:var(--ds-space-4);border:1px solid ${sl.targetExists ? "var(--ds-sky-200)" : "var(--ds-red-200)"};background:${sl.targetExists ? "var(--ds-blue-50)" : "var(--ds-red-50)"};border-radius:4px">
    ...
    <div class="fs-0" style="border-top:2px solid var(--ds-zinc-300);background:var(--ds-zinc-100)">
      <div role="group" aria-labelledby="kb-highlight-label" style="display:flex;align-items:center;gap:var(--ds-space-3);padding:var(--ds-space-3) var(--ds-space-6)">
        ...
        <label class="cur-pointer min-h-24" style="display:flex;align-items:center;gap:var(--ds-space-2);font-size:11px;font-weight:700;color:var(--ds-zinc-700);padding:var(--ds-space-2) var(--ds-space-4);border:1px solid var(--ds-zinc-300);border-radius:var(--ds-radius-3);background:#fff">
