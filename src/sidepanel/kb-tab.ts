 ...
 * - empty (no analyze): ds-empty placeholder
 * - all-pass: green "all elements have visible focus indicators" message
 ...
 * meaning analyze hasn't run): ds-empty / no-traps / list. Pure; exported.
 */
 ...
 * broken-target with color. Pure; exported for tests.
 */
