...
import { openConfigDialog } from "./scan-tab/config-dialog";
...
/* Test Configuration Panel (F13) — moved to ./scan-tab/config-dialog.ts */
...
function attachScanTabListeners(): void {
  ...
  document.getElementById("settings-btn")?.addEventListener("click", (e) => {
    ...
    openConfigDialog({ onClose: () => { configPanelOpen = false; renderScanTab(); }, rerender: renderScanTab });
  });
