          ...
          <div style="padding:8px;border:1px solid #e4e4e7;border-radius:4px;background:#fff;margin-bottom:6px" data-criterion="${c.id}">
            <div style="display:flex;align-items:center;gap:8px">
              ...
              <div style="display:flex;gap:2px;flex-shrink:0">
                <button class="manual-btn" data-id="${c.id}" data-status="pass" style="padding:4px 8px;font-size:11px;font-weight:700;border-radius:4px;cursor:pointer;min-height:24px;min-width:24px;border:none;${status === "pass" ? "background:#047857;color:#fff" : "background:#f4f4f5;color:#52525b"}">Pass</button>
                <button class="manual-btn" data-id="${c.id}" data-status="fail" style="padding:4px 8px;font-size:11px;font-weight:700;border-radius:4px;cursor:pointer;min-height:24px;min-width:24px;border:none;${status === "fail" ? "background:#b91c1c;color:#fff" : "background:#f4f4f5;color:#52525b"}">Fail</button>
                <button class="manual-btn" data-id="${c.id}" data-status="na" style="padding:4px 8px;font-size:11px;font-weight:700;border-radius:4px;cursor:pointer;min-height:24px;min-width:24px;border:none;${status === "na" ? "background:#3f3f46;color:#fff" : "background:#f4f4f5;color:#52525b"}">N/A</button>
              </div>
            </div>
