...
export function buildSrTabHtml(): string {
  ...
  return `
    <div class="fs-0" style="padding:var(--ds-space-4) var(--ds-space-6);border-bottom:1px solid var(--ds-zinc-200);display:flex;gap:var(--ds-space-4);background:var(--ds-zinc-50)">
      <button id="sr-analyze" class="f-1 cur-pointer min-h-24" style="padding:var(--ds-space-4);font-size:var(--ds-text-md);font-weight:800;color:var(--ds-amber-cta-fg);background:var(--ds-amber-500);border:none;border-radius:var(--ds-radius-3)">Analyze</button>
      ...
      ${srAnalyzed ? '<button id="sr-clear" class="cur-pointer min-h-24" style="padding:var(--ds-space-2) var(--ds-space-5);font-size:var(--ds-text-base);font-weight:700;color:var(--ds-red-600);border:1px solid var(--ds-red-200);border-radius:var(--ds-radius-3);background:none">Clear</button>' : ""}
    </div>
    ${scopeSelector ? `
      <div class="fs-0" style="padding:var(--ds-space-2) var(--ds-space-6);background:var(--ds-blue-50);border-bottom:1px solid var(--ds-blue-100);display:flex;align-items:center;gap:var(--ds-space-3)">
        ...
        <button id="sr-clear-scope" class="cur-pointer" style="font-size:var(--ds-text-sm);font-weight:700;color:var(--ds-red-600);border:none;background:none;padding:var(--ds-space-1) var(--ds-space-2)">Clear scope</button>
      </div>
    ` : ""}
