...
export function openConfigDialog(opts: iConfigDialogOptions): void {
  ...
  content.innerHTML = `
    <div style="display:flex;align-items:center;justify-content:space-between">
      <h2 id="config-dialog-title" style="margin:0;font-size:var(--ds-text-md);font-weight:800;color:var(--ds-zinc-800);text-transform:uppercase;letter-spacing:0.05em">Test Configuration</h2>
      <button type="button" id="config-close-btn" aria-label="Close" class="cur-pointer" style="width:24px;height:24px;display:flex;align-items:center;justify-content:center;border:none;background:none;color:var(--ds-zinc-500);border-radius:var(--ds-radius-3)">
    ...
    <a href="https://a11yscan.yantrakit.com/tools/test-config-builder" target="_blank" rel="noopener noreferrer" style="font-size:var(--ds-text-base);font-weight:700;color:var(--ds-indigo-700);text-decoration:none">Open Builder ↗</a>
    <textarea id="config-textarea" aria-label="Paste config JSON here" placeholder='Paste JSON config here, e.g. { "wcag": { "version": "2.1", "level": "AA" } }' class="font-mono" style="width:100%;box-sizing:border-box;font-size:var(--ds-text-base);padding:var(--ds-space-4);border:1px solid ${state.testConfig ? "var(--ds-amber-300)" : "var(--ds-zinc-300)"};border-radius:4px;resize:vertical;min-height:100px;background:#fff;color:var(--ds-zinc-800);line-height:1.5">${escHtml(configJson)}</textarea>
    <div id="config-error" role="alert" aria-live="polite" style="font-size:var(--ds-text-base);color:var(--ds-red-700);display:none"></div>
    <div style="display:flex;align-items:center;gap:var(--ds-space-3);flex-wrap:wrap">
      <button type="button" id="config-apply-btn" class="f-1 cur-pointer min-h-24" style="padding:var(--ds-space-4);font-size:var(--ds-text-md);font-weight:800;color:var(--ds-amber-cta-fg);background:var(--ds-amber-500);border:none;border-radius:var(--ds-radius-3)">Apply</button>
      <label id="config-upload-label" class="cur-pointer min-h-24" style="padding:var(--ds-space-2) var(--ds-space-5);font-size:var(--ds-text-base);font-weight:700;color:var(--ds-zinc-700);background:#fff;border:1px solid var(--ds-zinc-300);border-radius:var(--ds-radius-3);display:flex;align-items:center">
        Upload .json
      ...
      ${state.testConfig ? '<button type="button" id="config-clear-btn" class="cur-pointer min-h-24" style="padding:var(--ds-space-2) var(--ds-space-5);font-size:var(--ds-text-base);font-weight:700;color:var(--ds-red-600);background:none;border:1px solid var(--ds-red-200);border-radius:var(--ds-radius-3)">Clear Config</button>' : ""}
    </div>
  `;
