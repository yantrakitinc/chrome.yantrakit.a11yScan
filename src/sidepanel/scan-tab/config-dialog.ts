...
export function openConfigDialog(opts: iConfigDialogOptions): void {
  ...
  content.innerHTML = `
    <div style="display:flex;align-items:center;justify-content:space-between">
      ...
      <button type="button" id="config-close-btn" aria-label="Close" class="cur-pointer" style="width:24px;height:24px;display:flex;align-items:center;justify-content:center;border:none;background:none;color:var(--ds-zinc-500);border-radius:4px">
    ...
    <div style="display:flex;align-items:center;gap:6px;flex-wrap:wrap">
      <button type="button" id="config-apply-btn" class="f-1 cur-pointer min-h-24" style="padding:8px;font-size:12px;font-weight:800;color:var(--ds-amber-cta-fg);background:var(--ds-amber-500);border:none;border-radius:4px">Apply</button>
      ...
      ${state.testConfig ? '<button type="button" id="config-clear-btn" class="cur-pointer min-h-24" style="padding:4px 10px;font-size:11px;font-weight:700;color:var(--ds-red-600);background:none;border:1px solid var(--ds-red-200);border-radius:4px">Clear Config</button>' : ""}
    </div>
  `;
