  ...
  if (content) {
    content.innerHTML = `
      <div style="padding:var(--ds-space-8)">
        <div style="padding:var(--ds-space-6);background:var(--ds-red-50);border:1px solid var(--ds-red-200);border-radius:8px">
          <div style="font-size:var(--ds-text-md);font-weight:700;color:var(--ds-red-800);margin-bottom:var(--ds-space-2)">Scan failed</div>
