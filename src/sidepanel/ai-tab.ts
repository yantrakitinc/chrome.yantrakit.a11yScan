...
export function renderAiChatTab(): void {
  ...
  panel.innerHTML = `
    <div style="padding:8px 12px;border-bottom:1px solid #e4e4e7;display:flex;gap:8px;background:#fafafa;flex-shrink:0">
      <button type="button" id="new-chat" style="flex:1;padding:6px;font-size:12px;font-weight:700;color:#b45309;border:1px solid #fcd34d;border-radius:4px;background:none;cursor:pointer;min-height:24px">+ New chat</button>
      <button type="button" id="chat-history-btn" aria-label="Chat history" style="width:32px;height:32px;display:flex;align-items:center;justify-content:center;border:1px solid #d4d4d8;border-radius:4px;background:none;cursor:pointer;color:#71717a">
    ...
    <div id="chat-input-area" style="padding:8px 12px;border-top:1px solid #e4e4e7;background:#fff;flex-shrink:0">
      <div style="display:flex;gap:6px">
        ...
        <button type="button" id="chat-send" aria-label="Send message" style="width:36px;height:36px;display:flex;align-items:center;justify-content:center;background:#f59e0b;color:#1a1000;border:none;border-radius:4px;cursor:pointer">
  ...
  if (history.length === 0) {
    panel.innerHTML = `
      <div style="padding:12px;border-bottom:1px solid #e4e4e7;display:flex;align-items:center;justify-content:space-between">
        ...
        <button type="button" id="close-history" aria-label="Close history" style="width:24px;height:24px;display:flex;align-items:center;justify-content:center;border:none;background:none;cursor:pointer;color:#71717a">
    ...
    const items = history.map((conv) => `
      <div style="padding:10px 12px;border-bottom:1px solid #f4f4f5;display:flex;align-items:flex-start;gap:8px">
        ...
        <button type="button" class="history-delete" data-id="${conv.id}" aria-label="Delete conversation" style="width:24px;height:24px;display:flex;align-items:center;justify-content:center;border:1px solid #fecaca;border-radius:4px;background:none;cursor:pointer;color:#dc2626;flex-shrink:0">
          <svg aria-hidden="true" width="10" height="10" viewBox="0 0 10 10" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"><path d="M1 1l8 8M9 1L1 9"/></svg>
        </button>
      </div>
    `).join("");
