...
export const WCAG_CRITERIA: iWcagCriterion[] = [
  ...
  // AAA — Perceivable
  { id: '1.2.6', name: 'Sign Language (Prerecorded)', level: 'AAA', principle: 'Perceivable', axeRules: [], automation: 'manual', manualCheck: 'Verify prerecorded video has sign language interpretation.', versions: ['2.0', '2.1', '2.2'], relevantWhen: ['hasVideo'] },
  { id: '1.2.7', name: 'Extended Audio Description (Prerecorded)', level: 'AAA', principle: 'Perceivable', axeRules: [], automation: 'manual', manualCheck: 'Verify prerecorded video has extended audio description where pauses are insufficient.', versions: ['2.0', '2.1', '2.2'], relevantWhen: ['hasVideo'] },
  { id: '1.2.8', name: 'Media Alternative (Prerecorded)', level: 'AAA', principle: 'Perceivable', axeRules: [], automation: 'manual', manualCheck: 'Verify prerecorded video has a full text alternative describing all visual and auditory content.', versions: ['2.0', '2.1', '2.2'], relevantWhen: ['hasVideo'] },
  { id: '1.2.9', name: 'Audio-only (Live)', level: 'AAA', principle: 'Perceivable', axeRules: [], automation: 'manual', manualCheck: 'Verify live audio-only content has a real-time text alternative.', versions: ['2.0', '2.1', '2.2'], relevantWhen: ['hasAudio'] },
  { id: '1.4.6', name: 'Contrast (Enhanced)', level: 'AAA', principle: 'Perceivable', axeRules: ['color-contrast-enhanced'], automation: 'partial', manualCheck: 'Verify text contrast is 7:1 for normal text, 4.5:1 for large text.', versions: ['2.0', '2.1', '2.2'] },
  { id: '1.4.7', name: 'Low or No Background Audio', level: 'AAA', principle: 'Perceivable', axeRules: [], automation: 'manual', manualCheck: 'Verify speech audio has no background sounds, or background is at least 20dB lower than speech.', versions: ['2.0', '2.1', '2.2'], relevantWhen: ['hasAudio'] },
  { id: '1.4.8', name: 'Visual Presentation', level: 'AAA', principle: 'Perceivable', axeRules: [], automation: 'manual', manualCheck: 'Verify text blocks: foreground/background colors selectable by user, width ≤80 characters, not fully justified, line spacing ≥1.5, paragraph spacing ≥2x line spacing, text resizable to 200% without scrolling.', versions: ['2.0', '2.1', '2.2'] },
  { id: '1.4.9', name: 'Images of Text (No Exception)', level: 'AAA', principle: 'Perceivable', axeRules: [], automation: 'manual', manualCheck: 'Verify images of text are only used for pure decoration. No exceptions for customizable text.', versions: ['2.0', '2.1', '2.2'], relevantWhen: ['hasImages'] },

  // AAA — Operable
  { id: '2.1.3', name: 'Keyboard (No Exception)', level: 'AAA', principle: 'Operable', axeRules: [], automation: 'manual', manualCheck: 'Verify ALL functionality is operable through keyboard with no exceptions.', versions: ['2.0', '2.1', '2.2'] },
  { id: '2.2.3', name: 'No Timing', level: 'AAA', principle: 'Operable', axeRules: [], automation: 'manual', manualCheck: 'Verify timing is not an essential part of any activity (no time limits at all).', versions: ['2.0', '2.1', '2.2'], relevantWhen: ['hasTimeLimits'] },
  { id: '2.2.4', name: 'Interruptions', level: 'AAA', principle: 'Operable', axeRules: [], automation: 'manual', manualCheck: 'Verify interruptions (alerts, updates) can be postponed or suppressed by the user, except emergencies.', versions: ['2.0', '2.1', '2.2'] },
  { id: '2.2.5', name: 'Re-authenticating', level: 'AAA', principle: 'Operable', axeRules: [], automation: 'manual', manualCheck: 'Verify that when an authenticated session expires, the user can re-authenticate and continue without data loss.', versions: ['2.0', '2.1', '2.2'] },
  { id: '2.3.2', name: 'Three Flashes', level: 'AAA', principle: 'Operable', axeRules: [], automation: 'manual', manualCheck: 'Verify no content flashes more than three times per second (no threshold exception).', versions: ['2.0', '2.1', '2.2'], relevantWhen: ['hasAnimation'] },
  { id: '2.4.8', name: 'Location', level: 'AAA', principle: 'Operable', axeRules: [], automation: 'manual', manualCheck: 'Verify user\'s location within a set of pages is indicated (breadcrumbs, site map highlight, etc.).', versions: ['2.0', '2.1', '2.2'] },
  { id: '2.4.9', name: 'Link Purpose (Link Only)', level: 'AAA', principle: 'Operable', axeRules: [], automation: 'manual', manualCheck: 'Verify every link\'s purpose can be determined from link text alone (not from surrounding context).', versions: ['2.0', '2.1', '2.2'], relevantWhen: ['hasLinks'] },
  { id: '2.4.10', name: 'Section Headings', level: 'AAA', principle: 'Operable', axeRules: [], automation: 'manual', manualCheck: 'Verify content is organized using section headings.', versions: ['2.0', '2.1', '2.2'], relevantWhen: ['hasHeadings'] },

  // AAA — Understandable
  { id: '3.1.3', name: 'Unusual Words', level: 'AAA', principle: 'Understandable', axeRules: [], automation: 'manual', manualCheck: 'Verify a mechanism is available to identify definitions of words used in unusual or restricted ways, including idioms and jargon.', versions: ['2.0', '2.1', '2.2'] },
  { id: '3.1.4', name: 'Abbreviations', level: 'AAA', principle: 'Understandable', axeRules: [], automation: 'manual', manualCheck: 'Verify a mechanism is available to identify the expanded form of abbreviations.', versions: ['2.0', '2.1', '2.2'] },
  { id: '3.1.5', name: 'Reading Level', level: 'AAA', principle: 'Understandable', axeRules: [], automation: 'manual', manualCheck: 'Verify supplemental content or an alternative version is available when text requires reading ability above lower secondary education level.', versions: ['2.0', '2.1', '2.2'] },
  { id: '3.1.6', name: 'Pronunciation', level: 'AAA', principle: 'Understandable', axeRules: [], automation: 'manual', manualCheck: 'Verify a mechanism is available to identify pronunciation of words where meaning is ambiguous without pronunciation.', versions: ['2.0', '2.1', '2.2'] },
  { id: '3.2.5', name: 'Change on Request', level: 'AAA', principle: 'Understandable', axeRules: [], automation: 'manual', manualCheck: 'Verify changes of context are initiated only by user request, or a mechanism is available to turn off such changes.', versions: ['2.0', '2.1', '2.2'] },
  { id: '3.3.5', name: 'Help', level: 'AAA', principle: 'Understandable', axeRules: [], automation: 'manual', manualCheck: 'Verify context-sensitive help is available for form inputs and interactions.', versions: ['2.0', '2.1', '2.2'], relevantWhen: ['hasForms'] },
  { id: '3.3.6', name: 'Error Prevention (All)', level: 'AAA', principle: 'Understandable', axeRules: [], automation: 'manual', manualCheck: 'Verify ALL form submissions are reversible, verified, or confirmable (not just legal/financial).', versions: ['2.0', '2.1', '2.2'], relevantWhen: ['hasForms'] },
